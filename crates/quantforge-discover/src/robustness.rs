...
// Legacy optimizer-profile defaults retained for the desktop request schema.
// They are diagnostics only; the production battery uses the configured
// neighborhood sample count and survival fraction.
