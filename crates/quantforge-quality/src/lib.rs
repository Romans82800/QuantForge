...
pub use challenge::{
    ...
    ChallengeReport, CostShockPoint, CostShockReport, MONTE_CARLO_MAX_DRAWDOWN_RATIO,
    MONTE_CARLO_P80_PROFIT_RETENTION, MONTE_CARLO_SKIP_TRADE_PROBABILITY, MonteCarloReport,
