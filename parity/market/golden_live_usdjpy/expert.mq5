...
//|    Strategy fingerprint: e5fcaad9241ee39904e994571d1047565f341e3650d19c67d909c6a799e48d43
//+------------------------------------------------------------------+
...
input string CustomComment="QFMarketGolden";
...
input string InpParityPrefix="QuantForge\\QF_e5fcaad9241e";
...
// Broker specification hash: c2bb5c2b36795024d2444ad40f71fb2495ebb9b57172ee756bd1c8f89b13978b
...
bool QFOpenOrder(const bool buy)
{
   ...
   const string comment="QF-e5fcaad9241e";
   bool sent=false;
   if(entry_kind==0)
      sent=buy
...
int OnInit()
{
   if(_Symbol!="USDJPY")
   {
      Print("QuantForge export is broker-bound to USDJPY, not ",_Symbol);
   ...
   if((bool)MQLInfoInteger(MQL_TESTER) && StringLen(InpParityPrefix)>0)
   {
      ...
      if(g_metadata_file!=INVALID_HANDLE)
      {
         ...
         FileWrite(g_metadata_file,"strategy_fingerprint","e5fcaad9241ee39904e994571d1047565f341e3650d19c67d909c6a799e48d43");
         FileWrite(g_metadata_file,"broker_spec_hash","c2bb5c2b36795024d2444ad40f71fb2495ebb9b57172ee756bd1c8f89b13978b");
