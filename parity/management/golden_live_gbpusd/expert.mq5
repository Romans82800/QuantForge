//+------------------------------------------------------------------+
//| QFManagementGolden EA
//|
//|    Generated by QuantForge SQX-style export for MetaTrader5
//|    Strategy fingerprint: b5fba5a9d21753a87c3c17da21a08550fd74b62dd3f783881db2b94ecc208e56
//+------------------------------------------------------------------+
...
input string CustomComment="QFManagementGolden";
...
input string InpParityPrefix="QuantForge\\QF_b5fba5a9d217";
...
// Broker specification hash: 811c32cb57af1fd5a1e2552a9b6a26c6c8cc5ff910d74c0fae7fc6c4729711c7
...
{
   return g_initial_risk*0.750000000000;
}
...
{
   if(index==0) return 1.000000000000;
   if(index==1) return 2.000000000000;
   return 0.0;
}

double QFPartialFraction(const int index)
{
   if(index==0) return 0.500000000000;
   if(index==1) return 0.500000000000;
   return 0.0;
}
...
bool QFOpenOrder(const bool buy)
{
   ...
   const string comment="QF-b5fba5a9d217";
   bool sent=false;
   if(entry_kind==0)
      sent=buy
...
int OnInit()
{
   if(_Symbol!="GBPUSD")
   {
      Print("QuantForge export is broker-bound to GBPUSD, not ",_Symbol);
   ...
   if((bool)MQLInfoInteger(MQL_TESTER) && StringLen(InpParityPrefix)>0)
   {
      ...
      if(g_metadata_file!=INVALID_HANDLE)
      {
         ...
         FileWrite(g_metadata_file,"strategy_fingerprint","b5fba5a9d21753a87c3c17da21a08550fd74b62dd3f783881db2b94ecc208e56");
         FileWrite(g_metadata_file,"broker_spec_hash","811c32cb57af1fd5a1e2552a9b6a26c6c8cc5ff910d74c0fae7fc6c4729711c7");
