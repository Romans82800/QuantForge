...
//|    Strategy fingerprint: 61bf99b89a9adc054044ec8c6e0e9a956c66a23e142f19fc3e5c5963bfc1bd5f
//+------------------------------------------------------------------+
...
input string CustomComment="QFStopGolden";
...
input string InpParityPrefix="QuantForge\\QF_61bf99b89a9a";
...
// Broker specification hash: 0b53bcb27cf6506a6fabec608496798810c57325fb0b4157d623ddf82cc2da84
...
{
   return QFCrossBelow(QFMA(MODE_EMA,PRICE_CLOSE,12,(1+extra_shift)),QFMA(MODE_EMA,PRICE_CLOSE,48,(1+extra_shift)),QFMA(MODE_EMA,PRICE_CLOSE,12,(1+(extra_shift+1))),QFMA(MODE_EMA,PRICE_CLOSE,48,(1+(extra_shift+1))));
}
...
{
   return stop_distance*2.500000000000;
}
...
{
   return QFATR(14,1)*0.750000000000;
}
...
bool QFOpenOrder(const bool buy)
{
   ...
   const string comment="QF-61bf99b89a9a";
   bool sent=false;
   if(entry_kind==0)
      sent=buy
...
int OnInit()
{
   if(_Symbol!="AUDUSD")
   {
      Print("QuantForge export is broker-bound to AUDUSD, not ",_Symbol);
   ...
   if((bool)MQLInfoInteger(MQL_TESTER) && StringLen(InpParityPrefix)>0)
   {
      ...
      if(g_metadata_file!=INVALID_HANDLE)
      {
         ...
         FileWrite(g_metadata_file,"strategy_fingerprint","61bf99b89a9adc054044ec8c6e0e9a956c66a23e142f19fc3e5c5963bfc1bd5f");
         FileWrite(g_metadata_file,"broker_spec_hash","0b53bcb27cf6506a6fabec608496798810c57325fb0b4157d623ddf82cc2da84");
